...
## Parts and Budget ($440)
My total budget comes out to exactly **$440.00**. You can see the full, itemized spreadsheet tracking every single motor link, rail cost, and screw box directly inside the [`bom.csv`](./bom.csv) file in this repository.
